...
Class Exemple {
	...
	public function __construct( array $kwargs ) {
		...
		if ( array_key_exists( 'arg3', $kwargs ))
			...
			$this->att3 = $this->att1;
		print( '$this->karg1: ' . $kwargs['arg1'] . PHP_EOL );
		print( '$this->karg2: ' . $kwargs['arg2'] . PHP_EOL );
		print( '$this->karg3: ' . $kwargs['arg3'] . PHP_EOL );
...
$instance = new Exemple( array( 'arg3' => 31, 'arg2' => 42, 'arg1' => 53 ));
